...
The separate `shape-depth` suite uses [portable synthetic preparation](../docs/shape-depth.md)
and the [shape-depth engine guide](../engines/README.md#shape-depth-workloads).
It is not generated by the TPC-H `build-scale` command.
