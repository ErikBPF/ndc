...
- E18 now depends on both selected items and returns two columns. Independent
  DuckDB execution produced `10996|1027906826.10|` for qualifying-order
  count and total top-two revenue.
- Other pins retained their original contents and were independently checked;
  see [validation evidence](../../docs/validation-2026-09-07.md).
